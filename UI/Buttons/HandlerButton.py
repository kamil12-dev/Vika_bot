...
class HandlerButton(Button):
    ...
    def __init__(self, bot: AyameBot, handler: type[AbstractHandler], emoji: VEmojis, textChannel: TextChannel, guildID: int, category: MessagesCategory, label=None, *args, **kwargs):
