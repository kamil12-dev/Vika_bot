...
from Config.Exceptions import BadCommandUsage, AyameError, InvalidInput, NumberRequired, UnknownError
...
class MoveHandler(AbstractHandler):
    def __init__(self, ctx: Union[Context, Interaction], bot: AyameBot) -> None:
    ...
    def __validateInput(self, pos1: str, pos2: str) -> Union[AyameError, None]:
        try:
            pos1 = int(pos1)
            pos2 = int(pos2)
        except:
