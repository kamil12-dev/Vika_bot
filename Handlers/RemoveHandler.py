...
from Config.Exceptions import BadCommandUsage, AyameError, ErrorRemoving, InvalidInput, NumberRequired
...
class RemoveHandler(AbstractHandler):
    ...
    def __validateInput(self, position: str) -> Union[AyameError, None]:
        try:
